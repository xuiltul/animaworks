...
| ロール | 概要 | デフォルトモデル |
|--------|------|-----------------|
| manager | 委任・報告・エスカレーション判断 | Claude Opus 4.6 |
| engineer | コード実装・技術設計・テスト | Claude Opus 4.6 |
| researcher | 情報収集・分析・レポート | Claude Sonnet 4.6 |
| writer | 文書作成・コミュニケーション設計 | Claude Sonnet 4.6 |
| ops | 監視・異常検知・インシデント対応 | openai/glm-4.7-flash (vLLM) |
| general | 汎用タスク（デフォルト） | Claude Sonnet 4.6 |
