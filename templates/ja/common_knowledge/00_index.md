...
10. **自分が何で構成されているか知りたい / identity.md と injection.md の違いがわからない**
   → `anatomy/anima-anatomy.md` を読む

10.5. **記憶の仕組みを知りたい / 記憶の種類や使い分けがわからない**
   → `anatomy/memory-system.md` を読む

11. **AnimaWorksで何ができるか知りたい / 活用例を見たい**
   → `usecases/usecase-overview.md` を読む
...
| ファイル | 概要 |
|---------|------|
| `anatomy/what-is-anima.md` | Animaとは何か（概念・設計思想・ライフサイクル・実行パス） |
| `anatomy/anima-anatomy.md` | 構成ファイル完全ガイド（identity / injection / heartbeat / cron 等の役割・違い・変更ルール） |
| `anatomy/memory-system.md` | 記憶システムガイド（記憶の種類・Priming・Consolidation・Forgetting・ツール使い分け） |
...
### usecases/ — ユースケースガイド（初めての方向け）

| ファイル | 概要 |
|---------|------|
| `usecases/usecase-overview.md` | ユースケースガイド概要（AnimaWorksでできること・始め方・全テーマ一覧） |
| `usecases/usecase-communication.md` | コミュニケーション自動化（チャット・メール監視、エスカレーション、定期連絡） |
| `usecases/usecase-development.md` | ソフトウェア開発支援（コードレビュー、CI/CD監視、Issue実装、バグ調査） |
| `usecases/usecase-monitoring.md` | インフラ・サービス監視（死活監視、リソース監視、SSL証明書、ログ分析） |
| `usecases/usecase-secretary.md` | 秘書・事務サポート（スケジュール管理、連絡調整、日報作成、リマインダー） |
| `usecases/usecase-research.md` | 調査・リサーチ・分析（Web検索、競合分析、市場調査、レポート作成） |
| `usecases/usecase-knowledge.md` | ナレッジ管理・ドキュメント整備（手順書作成、FAQ構築、教訓の蓄積） |
| `usecases/usecase-customer-support.md` | カスタマーサポート（一次対応、FAQ自動回答、エスカレーション管理） |
...
| Anima, アニマ, 自分, 構成, 構造, 設計 | `anatomy/what-is-anima.md` |
| identity, injection, 人格, 職務, 性格, 行動指針 | `anatomy/anima-anatomy.md` |
| identity.md, injection.md, 違い, 不変, 可変 | `anatomy/anima-anatomy.md` |
| heartbeat, cron, 定期巡回, 定時タスク, 定期行動 | `anatomy/anima-anatomy.md`, `operations/heartbeat-cron-guide.md` |
| permissions.md, status.json, 設定, 権限 | `anatomy/anima-anatomy.md` |
| bootstrap, 初回起動, 初期化 | `anatomy/anima-anatomy.md` |
| 記憶, メモリ, memory, episodes, knowledge, procedures | `anatomy/memory-system.md` |
| 短期記憶, エピソード, 意味記憶, 手続き記憶 | `anatomy/memory-system.md` |
| Priming, RAG, Consolidation, Forgetting, 忘却 | `anatomy/memory-system.md` |
| search_memory, write_memory_file, 記憶検索, 記憶書き込み | `anatomy/memory-system.md` |
| ユースケース, 活用例, 使い方, 何ができる | `usecases/usecase-overview.md` |
| メール自動化, チャット監視, 通知 | `usecases/usecase-communication.md` |
| コードレビュー, PR, CI/CD, 開発 | `usecases/usecase-development.md` |
| 監視, サーバー, SSL, アラート, 障害 | `usecases/usecase-monitoring.md` |
| 秘書, スケジュール, リマインダー, 日報 | `usecases/usecase-secretary.md` |
| 調査, リサーチ, 競合分析, 市場調査 | `usecases/usecase-research.md` |
| ナレッジ, 手順書, FAQ, ドキュメント | `usecases/usecase-knowledge.md` |
| カスタマーサポート, 問い合わせ, サポート | `usecases/usecase-customer-support.md` |
