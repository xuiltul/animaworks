...
- モデル選択・設定 → `operations/model-guide.md`
...
詳細 → `common_knowledge/operations/model-guide.md`
...
animaworks send {送信者} {受信者} "メッセージ" --intent delegation
...
animaworks config list --section system  # セクション指定
...
animaworks config export-sections        # テンプレートファイルにエクスポート
...
animaworks init --skip-anima             # Anima作成をスキップ
