...
Heartbeat는 관찰·계획·제출에 사용합니다. 실제 작업은 `submit_tasks`로 제출한 TaskExec가 별도 세션에서 수행합니다. 장부의 pending은 당신이 제출했을 때 실행됩니다.
...
태스크 큐의 **pending**(이전 TaskExec가 완료 선언 없이 끝난 것 포함)은 당신이 제출했을 때 실행됩니다:
