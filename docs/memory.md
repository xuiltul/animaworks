...
> 作成日: 2026-02-14
> 関連: [vision.md](vision.md), [spec.md](spec.md), [design/priming-layer-design.md](design/priming-layer-design.md)
> 調査資料: [AI Agent記憶アーキテクチャ調査](../archive/kaisha-design/docs/20260212_AI_Agent記憶アーキテクチャ調査.md) セクション10
...
- [design/priming-layer-design.md](design/priming-layer-design.md) — プライミングレイヤー実装計画書（RAG設計、固定化アーキテクチャ含む）
- [AI Agent記憶アーキテクチャ調査](../archive/kaisha-design/docs/20260212_AI_Agent記憶アーキテクチャ調査.md) — 脳科学調査・先行研究サーベイ
