...
Verifies that a realistic multi-person hierarchy produces correct
...
class TestOrgContextE2E:
    ...
    @pytest.fixture
    def org_team(self, data_dir: Path, make_person):
    ...
    def test_solo_person_no_communication_rules(self, data_dir: Path, make_person):
        """A solo person should not see communication rules."""
        make_person("solo")
