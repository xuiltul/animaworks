...
class TestCleanSlackMarkup:
    ...
    def test_user_mention_no_cache(self):
        result = clean_slack_markup("Hello <@U0TEST000001>!")
        assert "@U0TEST000001" in result
        assert "<@U0TEST000001>" not in result

    def test_user_mention_with_cache(self):
        cache = {"U0TEST000001": "Alice"}
        result = clean_slack_markup("Hello <@U0TEST000001>!", cache=cache)
