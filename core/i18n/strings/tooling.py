...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "prompt_db.read_channel": {
        ...
        "en": (
            "Read recent messages from a Board channel. See what other Animas and users have shared. Use this for team/department channels or general/ops as needed. human_only=true filters to user messages only."
        ),
        "ko": (
            "Board 채널에서 최근 메시지를 읽는다. 다른 Anima나 사용자가 공유한 정보를 확인할 수 있다. 소속 부서/팀 채널이나 general/ops의 공유 상황을 확인할 때 사용. human_only=true로 사용자 발언만 필터링 가능."
        ),
    },
    ...
    "completion_gate.checklist": {
        "ja": (
            ...
            "- [ ] 依頼されたものを簡略化・省略していない\n"
            "- [ ] 使用したスキル/手順があれば applied_*_refs に含めた\n"
            "- [ ] 再利用可能な能力を得た場合は create_skill で作成した、または作成不要の理由を skill_creation に含めた\n"
        ...
        "en": (
            ...
            "- [ ] Any applied skills/procedures were included in applied_*_refs\n"
            "- [ ] If a reusable capability was learned, create_skill was used or skill_creation explains why not\n"
        ...
        "ko": (
            ...
            "- [ ] 사용한 스킬/절차가 있으면 applied_*_refs에 포함했다\n"
            "- [ ] 재사용 가능한 능력을 배웠다면 create_skill을 사용했거나 skill_creation에 만들지 않은 이유를 포함했다\n"
